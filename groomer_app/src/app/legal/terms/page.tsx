...
export default function TermsPage() {
  return (
    <div className="space-y-6 text-base leading-8 text-gray-900">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-900">6. 知的財産権</h2>
        <p>本サービスに関する著作権その他の知的財産権は、当運営者または正当な権利者に帰属します。</p>
      </section>

      <section>
        <h2 className="text-lg font-semibold text-gray-900">7. 免責</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-900">8. 規約変更</h2>
        <p>当運営者は、必要に応じて本規約を変更できます。変更後の規約は本サービス上に表示した時点で効力を生じます。</p>
      </section>

      <section>
        <h2 className="text-lg font-semibold text-gray-900">9. 準拠法・裁判管轄</h2>
        <p>
