    ...
    <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.3fr_1fr]">
            ...
            <Card>
              ...
              <div className="space-y-3">
                ...
                <Link href={buildDashboardHref('reoffers', followupWindowDays)} className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3"><div><p className="text-sm font-semibold text-slate-900">空き枠再販</p><p className="text-xs text-slate-700">受付 {reofferAcceptedCount} 件 / 予約化 {reofferAppointmentCreatedCount} 件</p></div><span className="text-sm font-semibold text-slate-800">開く</span></Link>
      ...
      {activeTab === 'followups' ? (
        <>
          ...
          <Card>
            <div className="mb-4 flex items-center justify-between"><h2 className="text-lg font-semibold text-gray-900">再来店フォロー隊列</h2><Link href="/customers/manage?view=alerts" className="text-sm font-semibold text-blue-700">顧客ペット管理へ</Link></div>
